...
const a = (e, i, s) =>
  ...
  g = /.*(jpe?g|png|gif|svg|bmp|log|xlsx?|exe|gz|zip|txt|doc|docx|pdf|mp3|mp4|7z|html|css|js|xml|java|py|c|csv|flac|json|ya?ml|ini|epub|)/i,
  p = /!\[\[(.*?)\]\]/i,
  f = new Set([
    "jpeg",
    "jpg",
    ...
    super(...arguments),
      ...
      (this.clearUnusedAttachments = (i) =>
        t(this, void 0, void 0, function* () {
          ...
          } else new e.Notice(`All ${"image" === i ? "images" : "attachments"} are used. Nothing was deleted.`);
        }));
  }
  onload() {
