...
- [为什么 2,621 个班只出 1 个班（过滤链逐层核对）](filter-analysis-2026-09-10.md)
- [部门白名单口径不一致（1,318 个班被挡）](dept-whitelist-gap.md)
- [核心口径与排查手册](runbook.md)
- [scripts/](scripts/) —— 捞 Job 日志 + 分类计数，复跑「班级被哪层过滤」用 —— 表结构 / ES 字段 / 反射入口 / 已知坑
